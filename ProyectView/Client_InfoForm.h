...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->ClientFemale->Location = System::Drawing::Point(14, 19);
			...
			this->GroupBoxGender->Location = System::Drawing::Point(541, 235);
